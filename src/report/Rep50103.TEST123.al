report 50103 "TEST123"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'TestAryaFormat.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    saleLine.Reset();
                    saleLine.SetRange("Document Type", "Sales Header"."Document Type");
                    saleLine.SetRange("Document No.", "Sales Header"."No.");
                    saleLine.SetFilter("GST Group Code", '<>%1', '');
                    if saleLine.FindSet() then
                        repeat
                            TaxRecordID := saleLine.RecordId();//NP
                            ...
                            Total += saleLine."Line Amount";
                        until saleLine.Next() = 0;
                    //grandTotal := Total + CGSTAmount + SGSTAmount + IGSTAmount;
                    //taxTotal += CGSTAmount + IGSTAmount + SGSTAmount;
            ...
            //     end;
            //     customer.Reset();
            //     customer.SetRange(Name, "Sales Header"."Buy-from Vendor Name");
