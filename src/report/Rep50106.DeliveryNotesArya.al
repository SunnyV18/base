report 50106 "Delivery Notes Arya"
{
    Caption = 'Delivery Note';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'DeliveryNoteArya.rdl';
    dataset
    {
...

        {
            ...
            dataitem("Sales Shipment Line"; "Sales Shipment Line")
            {
                ...
                begin
                    ...
                    if "Sales Shipment Line".FindSet() then begin
                        "Line Amount" += "Sales Shipment Line".Quantity * "Sales Shipment Line"."Unit Cost";
                    end;
